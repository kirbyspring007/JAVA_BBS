	...
	<div class="container">
		<div class="row">
			...
			<% 
				if(pageNumber != 1){
			 %>
				 <a href="bbs.jsp?pageNumber=<%=pageNumber - 1%>" class="btn btn-success btn-arraw-lift">前</a>
			 <% 
				} if(bbsDAO.nextPage(pageNumber + 1)){ 
			 %>
			 	 <a href="bbs.jsp?pageNumber=<%=pageNumber + 1%>" class="btn btn-success btn-arraw-lift">次</a>
			 <%
				}
			 	%>
